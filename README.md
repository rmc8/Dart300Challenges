...
8. null合体演算子（??）を使用して、nullの場合にデフォルト値を設定するプログラムを書いてください。
9. 条件演算子（?.）を使用して、nullでない場合にのみメソッドを呼び出すプログラムを書いてください。
...
2. 複数の引数を受け取り、それらの和を返す関数を作成してください。
...
15. 可変長引数（...）を受け取る関数を作成し、任意の数の引数を処理するプログラムを書いてください。
